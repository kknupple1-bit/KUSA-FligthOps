const CACHE_NAME="kusa-flightops-shell-v5.25.43";
const SHELL=["/","/index.html","/config.js","/manifest.webmanifest","/icons/icon-192.png","/icons/icon-512.png","/data/f900b_qrh_rev02.json","/data/f900b_operational_overlays_v52541.json","/data/f900b_n699bg_wb_v52542.json"];
