...
const F50_DIGITIZATION_STATUS={
  ...
  pending:[
    ...
    'S+Flaps 20° BFL / V1 — FTA-PA-001019 §5-17 plus applicable V1 relation',
...
const F50_DASSAULT_SOURCE={
 takeoff:{
  S20:{vr:"DTM813 §5.45.8",vfr:"DTM813 §5.15 / transition schedule",vfrDelta:15,field:"BFL/V1 legacy digitization under direct-source migration • balanced-field ASD follows DTM813 §5.05 definition"},
  SLATS:{vr:"DTM813 §5.50.10 — direct digitization complete",vfr:"DTM813 §5.15 / transition schedule",vfrDelta:25,field:"BFL/V1 legacy digitization under direct-source migration • balanced-field ASD follows DTM813 §5.05 definition"}
 },
...
function updateVSpeedCard(tow,landing){
 ...
 $("vsV1src").textContent=v1==null?"Requires valid PA / temperature / weight cell":`${FS_PERF.takeoff[toAuto.cfg].label} • LEGACY DIGITIZATION • Dassault field-source migration pending`;
...
async function startupCheck(manual=false){
 const expected="5.25.17",bs=$("startupBuildStatus"),bn=$("startupBuildNote"),ps=$("startupPerfStatus"),pn=$("startupPerfNote"),rs=$("startupRunwayStatus"),rn=$("startupRunwayNote"),ls=$("startupLiveStatus"),ln=$("startupLiveNote"),notice=$("startupDataNotice"),btn=$("refreshDataStatusBtn");
