...
const F50_DIGITIZATION_STATUS={
  complete:[
    ...
    'S+Flaps 20° §5.45.6 BFL nomograph panels — expanded published-anchor regression now 3/4 within 250 ft; §5.45.12 34,000 lb point exposed +521 ft weight-panel error and blocks release',
  ...
  pending:[
    ...
    'S+Flaps 20° BFL production activation / §5.45.7 V1 — §5.45.6 direct shadow engine is HOLD pending weight-family re-digitization; §5.45.7 V1 output-axis and published source anchors added, continuous panel solver still pending',
